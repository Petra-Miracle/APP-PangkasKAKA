...
const styles = StyleSheet.create({
  ...
  label: { color: COLORS.textMuted, marginTop: 14, marginBottom: 10, fontSize: 12, fontFamily: FONT.semibold, letterSpacing: 0.3 },
  ...
  okBox: { alignItems: "center", padding: 24, gap: 14 },
  okIcon: { width: 68, height: 68, borderRadius: 22, backgroundColor: COLORS.success, alignItems: "center", justifyContent: "center", shadowColor: COLORS.success, shadowOpacity: 0.35, shadowRadius: 14, elevation: 6 },
